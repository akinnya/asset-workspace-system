...
export async function refreshTokenUsingPost(
  body: API.UserRefreshRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseLoginUserVO_>('/api/user/refresh', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 获取用户统计信息 GET /api/user/get/stats */
export async function getUserStatsUsingGet(
  params: { userId: number },
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseUserStatsVO_>('/api/user/get/stats', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** 获取用户个人主页摘要 GET /api/user/profile/summary */
export async function getProfileSummaryUsingGet(
  params: { userId: number },
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseUserProfileSummaryVO_>('/api/user/profile/summary', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** sendRegisterCode POST /api/user/register/code */
export async function sendRegisterCodeUsingPost(
  body: API.UserEmailCodeRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/user/register/code', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** updateEmail POST /api/user/email/update */
export async function updateEmailUsingPost(
  body: API.UserEmailUpdateRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/user/email/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
